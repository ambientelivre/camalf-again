...
public class CreateDirectoryRequest extends AbstractConnectorRequest<EmptyResponse> {

  private static final Logger LOGGER = LoggerFactory.getLogger(CreateDirectoryRequest.class);
  ...
  public CreateDirectoryRequest(Connector<?> connector) {
    super(connector);
  ...
  public CreateDirectoryRequest to(String to) {
  ...
  public CreateDirectoryRequest from(String from) {
  ...
  public CreateDirectoryRequest fromAlias(String alias) {
  ...
  public CreateDirectoryRequest cc(String cc) {
  ...
  public CreateDirectoryRequest bcc(String bcc) {
  ...
  public CreateDirectoryRequest subject(String subject) {
  ...
  public CreateDirectoryRequest text(String text) {
  ...
  public CreateDirectoryRequest html(String html) {
  ...
  public CreateDirectoryRequest fileNames(String... fileNames) {
  ...
  public CreateDirectoryRequest files(Map<String, ByteArrayInputStream> files) {
